...
import { formatDate, formatAmount } from '../../../shared/utils/formatters';
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {transaction.category && (
                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium whitespace-nowrap ${transaction.category === 'Uncategorized'
                  ...
                  {transaction.account && (
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium whitespace-nowrap bg-blue-100 text-blue-700">
                      {transaction.account}
                    </span>
                  )}
                </div>
